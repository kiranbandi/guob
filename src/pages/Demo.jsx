...
function RenderDemo({ isDark }) {
            ...
            .then(async data => {
                ...
                if (collinearity) {
                    ...
                    if (given_file.includes('.bed')) {
                        ...
                        console.log('WHERE IM SUPPOSED TO BE');
                        return sendFileToWorkers('gff', data, nameDesignation);
                    }
                }
            })
    ...
    return (
        <div css={styling}>
            {firstLoad ? (
                <img src={'files/Arabidopsis_image.png'}></img>
            ) : (
                <>
                    <Typography
                        variant={'h5'}
                    ...
                    >
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    if (
                                        JSON.stringify(demoFile) !==
                                        JSON.stringify([
                                            'files/topas/all_gene_expression_100k.bed',
                                            'files/topas/all_smallRNA_100k.bed',
                                            'files/topas/leaf_gene_expression_100k.bed',
                                            'files/topas/leaf_smallRNA_100k.bed',
                                            'files/topas/seed_gene_expression_100k.bed',
                                            'files/topas/seed_smallRNA_100k.bed',
                                        ])
                                    )
                                        setLoading(true);
                        ...
                        >
                            ...
                            />
                            <FormControlLabel
                                control={<Switch onChange={enableGT} />}
