...
*/
function Window({ color="inherit", coordinateX, coordinateY, width, height, preview, text, grouped, label=undefined }) {
        ...
        return (
           ...
           { preview && <div className={className} style={{position: 'absolute', borderStyle: 'solid', borderColor: color, borderWidth: 2, top: coordinateY - 1, left: coordinateX-(+width/2), width: width, height: height, zIndex: 1, pointerEvents: 'none' }}>
            </div>} 
            </>
        )
