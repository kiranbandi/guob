            ...
            arrayCoordinates.map((item, index) => {
                ...
                if (item.type === "line") {
                    ...
                    if (color) {
                        ...
                        ctx.strokeStyle = 'none';
                        ctx.fillStyle = Turbocolors[Math.round(index * Turbocolors.length / totalLines)]
            ...
            pathList = arrayCoordinates.map((item, index) => {
                if (item.type === "line") {
                    ...
                    if (color) {
                        ...
                        return <path d={createLinkPolygonPath({ item }, curvature)} key={index} fill={Turbocolors[Math.round(index * Turbocolors.length / totalLines)]} ></path>
                    }
